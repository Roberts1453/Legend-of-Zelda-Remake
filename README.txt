...
Code Analysis:
110 Warnings
All are about variables that are not used yet from things that weren't fully finished.

9 Messages
Saying "Make field readonly"

The results of the code analysis are just noting the existance of things aren't used yet.
