...
namespace Sprint0Project
{
    ...
    public class Dodongo : ICharacter
    {
        ...
        Vector2 dodongoCenter;
        Vector2 dodongoSizeOffset = new Vector2(5, 0);
        ISprite dodongoSprite = EnemySpriteFactory.Instance.CreateAquamentusSprite();
        ...
        public Dodongo(Vector2 location)
        {
            ...
            dodongoCenter = location + dodongoSizeOffset;
        ...
        public Dodongo(Vector2 location, ICollectibleItem dropItem)
        {
            this.location = location;
            dodongoCenter = location + dodongoSizeOffset;
