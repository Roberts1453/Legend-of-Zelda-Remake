...
namespace Sprint0Project
{
    ...
    public class PolsVoice : ICharacter
    {
        ...
        Vector2 polsVoiceCenter;
        Vector2 polsVoiceSizeOffset = new Vector2(5, 0);
        ISprite polsVoiceSprite = EnemySpriteFactory.Instance.CreatePolsVoiceSprite();
        ...
        public PolsVoice(Vector2 location)
        {
            ...
            polsVoiceCenter = location + polsVoiceSizeOffset;
        ...
        public PolsVoice(Vector2 location, ICollectibleItem dropItem)
        {
            this.location = location;
            startLocation = location;
            polsVoiceCenter = location + polsVoiceSizeOffset;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            polsVoiceSprite.Update(gameTime);
            edges = polsVoiceSprite.Edges();
        ...
        {
            polsVoiceSprite.Draw(spriteBatch, location);
        }
    }
