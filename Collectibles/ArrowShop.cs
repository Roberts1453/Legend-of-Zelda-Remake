...
{
    [Serializable]
    public class ArrowShop : ICollectibleItem
    {
        int price = 80;
        public Vector2 Location;
        ISprite bombSprite = ItemSpriteFactory.Instance.CreateArrowUpSprite();
        ISprite priceSprite1 = HUDSpriteFactory.Instance.CreateNumberSprite(80 / 10);
        ISprite priceSprite2 = HUDSpriteFactory.Instance.CreateNumberSprite(80 % 10);
        ...
        public ArrowShop(Vector2 location)
	    {
            Location = location;
