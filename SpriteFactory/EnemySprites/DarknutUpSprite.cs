...
{
    public class DarknutUpSprite : ISprite
    {
        ...
        public DarknutUpSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(525, 56, 16, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(548, 56, 16, 16);
            }
