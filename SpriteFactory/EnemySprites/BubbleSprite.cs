...
{
    public class BubbleSprite : ISprite
    {
        ...
        public BubbleSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(1029, 56, 14, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(1053, 56, 14, 16);
            }
