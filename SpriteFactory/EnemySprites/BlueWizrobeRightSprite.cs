...
{
    public class BlueWizrobeRightSprite : ISprite
    {
        ...
        public BlueWizrobeRightSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(1053, 80, 14, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(1077, 80, 14, 16);
            }
