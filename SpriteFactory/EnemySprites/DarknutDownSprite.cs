...
{
    public class DarknutDownSprite : ISprite
    {
        ...
        public DarknutDownSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(428, 56, 16, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(453, 56, 16, 16);
            }
