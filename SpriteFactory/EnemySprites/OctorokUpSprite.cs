...
{
    public class OctorokUpSprite : ISprite
    {
        ...
        public OctorokUpSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(60, 0, 16, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(60, 30, 16, 16);
            }
