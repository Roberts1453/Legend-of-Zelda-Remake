...
{
    public class BlueGoriyaUpSprite : ISprite
    {
        ...
        public BlueGoriyaUpSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(538, 32, 13, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(561, 32, 13, 16);
            }
