...
{
    public class PolsVoiceSprite : ISprite
    {
        ...
        public PolsVoiceSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(512, 104, 16, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(536, 104, 16, 16);
            }
