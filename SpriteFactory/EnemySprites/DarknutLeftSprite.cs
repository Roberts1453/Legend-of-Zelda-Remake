...
{
    public class DarknutLeftSprite : ISprite
    {
        ...
        public DarknutLeftSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(380, 56, 16, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(404, 56, 16, 16);
            }
