...
{
    public class WizrobeUpSprite : ISprite
    {
        ...
        public WizrobeUpSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(957, 80, 14, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(981, 80, 14, 16);
            }
