...
{
    public class WizrobeRightSprite : ISprite
    {
        ...
        public WizrobeRightSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(909, 80, 14, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(933, 80, 14, 16);
            }
