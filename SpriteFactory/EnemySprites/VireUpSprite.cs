...
{
    public class VireUpSprite : ISprite
    {
        ...
        public VireUpSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(116, 80, 16, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(140, 80, 16, 16);
            }
