...
{
    public class BlueWizrobeLeftSprite : ISprite
    {
        ...
        public BlueWizrobeLeftSprite(Texture2D spriteSheet)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            if (currentFrame == 0)
            {
                sourceRectangle = new Rectangle(1004, 80, 14, 16);
            }
            else
            {
                sourceRectangle = new Rectangle(1029, 80, 14, 16);
            }
