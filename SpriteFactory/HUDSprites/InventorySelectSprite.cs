...
{
    public class InventorySelectSprite : ISprite
    {
        ...
        public InventorySelectSprite(Texture2D spriteSheet)
        {
        ...
        {
            if (currentFrame == 0)
                sourceRectangle = new Rectangle(519, 137, 16, 16);
            else
                sourceRectangle = new Rectangle(536, 137, 16, 16);
