...
{
    public class TextTriangleSprite : ISprite
    {
        ...
        public TextTriangleSprite(Texture2D spriteSheet)
        {
        ...
        {
            if (currentFrame == 0)
                sourceRectangle = new Rectangle(385, 404, 21, 12);
            else
                sourceRectangle = new Rectangle(408, 404, 21, 12);
